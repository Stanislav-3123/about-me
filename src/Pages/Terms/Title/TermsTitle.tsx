    ...
    return (
        ...
        ">
            <div className="w-full inline-flex sm:justify-between sm:flex-row flex-col items-center sm:gap-8">
                ...
                sm:font-medium sm:whitespace-nowrap leading-snug self-start">Terms and Conditions</h1>
            ...
            <div className="relative bg-policies w-full sm:h-[260px] h-[220px] sm:bg-fixed bg-cover bg-center sm:bg-top sm:bg-contain rounded-tl-[1000px] rounded-tr-[300px] rounded-bl-[1000px] sm:rounded-br-[1500px] rounded-br-[1000px]">
            </div>
        </div>
    );
};
